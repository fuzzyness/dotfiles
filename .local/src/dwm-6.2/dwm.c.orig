...
struct Client {
	...
	int bw, oldbw;
	unsigned int tags;
	int isfixed, iscentered, isterminal, noswallow, isfloating, isfakefullscreen, isurgent, neverfocus, oldstate, isfullscreen, issticky; /*center*/ /*fakefullscreen*/ /*swallow*/
        pid_t pid; /*swallow*/
	Client *next;
	Client *snext;
